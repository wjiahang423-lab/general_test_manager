"""
check_sma760.py — SMA760 有效性检测

读取 DvEol_ObsIMUIn_Sma760DataValid_b（1 字节），期望整数值 0。
"""
...
def measure(params: dict) -> dict:
    try:
        ...
        result_hex = xcp.read_variable(
            variable_name="DvEol_ObsIMUIn_Sma760DataValid_b",
            a2l_dic=a2l,
            offset=0,
            length=1,
        )
        ...
        return {
            ...
            "unit": "",
            "pass": passed,
            "message": f"Sma760DataValid={result_hex}（int={actual_int}），期望=0",
        }
